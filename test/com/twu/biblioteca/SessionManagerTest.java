...
public class SessionManagerTest {
    User user = new User("123-4567", "password", "User 1", "Surname 1", "123-4567@biblioteca.com", 123456789);
    User nonExistingUser = new User("999-9999", "password", "User 9", "Surname 9", "999-9999@biblioteca.com", 999999999);
